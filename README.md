...
This project uses [javafx](https://openjfx.io/) and [maven](http://maven.apache.org/download.cgi) and Spring Boot. Go check them out if you don't have them locally installed. As we use Spring Boot, it so hard for us to pack the project into jar package.
