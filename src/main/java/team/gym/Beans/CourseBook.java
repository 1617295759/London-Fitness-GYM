...
public class CourseBook implements Serializable {
    ...
    public CourseBook(Integer conumint , Integer conumber ) {
        this.conum = conum;
        this.conumber = conumber;

    }

    public CourseBook(Integer conum, String coname, String coteacher, String comembername, Integer conumber, String cotime) {
        this.conum = conum;
        this.coname = coname;
