 ...
 ？？
    ...
    */
    ...
    public int saveCourse(Course course) {
        try {
            ...
            if(username.equals("Customer")) {
                ...
                Trainer trainer = (Trainer)trainerDao.findTrainerByAccount(trainerName);
            ...
            if(username.equals("Trainer")) {
                ...
                Customer customer = (Customer)customerDao.findCustomerByAccount(customerName);
    ...
    public Course selByCourseId(int courseId) {
        ...
        Customer customer = customerDao.findCustomerByAccount(course1.getCustomerAccount());
    ...
    public int delByCourseId(int courseId) {
        ...
        Trainer trainer = (Trainer)trainerDao.findTrainerByAccount(trainerName);
        Customer customer = customerDao.findCustomerByAccount(customerName);
        List<Course> courses = customer.getCourses();
